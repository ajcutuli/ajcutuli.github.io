...
![<img src="image-3.png" width="50%" height="50%">](image-3.png)
...
![<img src="image-2.png" width="50%" height="50%">](image-2.png)
...
, and $ \left{u_i\right}_{i=1}^{t} = \left{(u_{1i}, ..., u_{Ki})' \right}_{i=1}^{t} \subset \mathbb{R}^K$ 
